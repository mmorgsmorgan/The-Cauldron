  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="text-4xl font-black mb-3 gradient-text">Pro Mode</h1>
      ...
      {!isConnected ? (
        ...
        <>
          ...
          <div className="mt-8 text-center">
            <a href="/agent" className="text-xs" style={{ color: "rgba(200,247,197,0.25)" }}>
              Looking for the local agent setup? Go to Tier 1
            </a>
          </div>
        </>
      )}
